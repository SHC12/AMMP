        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nama.equals("")||username.equals("")||password.equals("")||path_foto.equals("")){
                    Toast.makeText(TambahPetugas.this, "Semua field wajib di isi", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void tambahPetugas(String nama, String username, String password, File foto) {
        ...
        tambahPetugas.enqueue(new Callback<ResponseBody>() {
                ...
                if(response.isSuccessful()){
                    ...
                    try {
                        ...
                        if(o.getString("status").equals("1")){
                            Toast.makeText(TambahPetugas.this, "Petugas berhasil di tambahkan", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(TambahPetugas.this,DataPetugas.class));
                        }else{
                            Toast.makeText(TambahPetugas.this, "Error", Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(TambahPetugas.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        switch (requestCode) {
            case 42:
                if (requestCode == 42 && resultCode == Activity.RESULT_OK) {
                    ...
                    path_foto = FilePath.getFilePath(TambahPetugas.this, uri);
